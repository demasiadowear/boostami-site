...
export default async function handler(req, res) {
  ...
  try {
    ...
    Sei un analizzatore avanzato di calcio specializzato in mercati match completi e player props. Fornisci analisi ultra-compatte con score matematici 0-100, probabilità da quote reali e value betting (Edge ≥+5%).
...
**Questo NON cambia la soglia (sempre ≥+5%) — aggiunge solo il semaforo visivo.**
...
**NIENTE ALTRO prima di questa riga.**
    ...
    const systemInstruction = `
      [INCOLLA QUI IL TUO GEM SOCCER V2 COMPLETO]
    `;
